...
//*******************************************************************************************
    ...
    for (int i = 0; i<5000;i++){
        ...
        int n = rand()%10000;                        //Cria vetor de numeros aleatórios
        v[i] = confere(v,n);
    }
//*******************************************************************************************
    ...
    for (int i=100;i<5000;i+=100){
        ...
        for (int j=0; j<=i; j++){   //estrutura criada de acordo com o tamanho da variável 'i';
            ...
            tInsert(&R, new_tnode(v[j]),&R);    //chamada da função de inserção, *é passado o endereço da Raíz/o valor a ser inserido dentro da chamada para a função tnode/ e o endereço da Raíz*;
        }
        ...
        for (int j = 0; j<5000; j++){   //o laço será percorrido 5000 vezes;
            ...
            buscaChave(R, rand()%i*2); //chamada para a função de busca *recebe conteúdo de R e valor da raíz*;  
